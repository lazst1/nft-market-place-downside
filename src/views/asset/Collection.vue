...
<template>
    <div class="relative h-13.5">
        ...
        >
            ...
            >
                <div class="flex-1">
                    <div class="selected flex items-center cursor-pointer h-12.5 text-sm">
            ...
            <div class="transition-all overflow-auto" :style="{ maxHeight: open ? '180px' : '0' }">
                <div
                    :class="[hoverColor[props.color], 'flex items-center h-12 cursor-pointer px-5']"
                    v-for="(option, i) of collections"
                    :key="i"
