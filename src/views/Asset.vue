    ...
    <body-container>
        <div class="grid grid-cols-7 text-white gap-8 mt-9">
            <div class="col-span-7 lg:col-span-3">
                <div
                    class="relative h-520 overflow-hidden p-6"
                    :style="{ background: 'url(' + asset.image_url + ')', backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'center', backgroundColor: '#222222' }"
                >
            ...
            <div class="col-span-7 lg:col-span-4 relative">
                ...
                <div class="flex pb-6 text-5/2xl">
                    ...
                    <div class="text-base text-tertiary-400 flex items-end font-ibm-semi-bold py-2">
                        ...
                        <font-awesome-icon
                            :icon="['fas', 'thumbs-up']"
                            class="text-2xl text-primary-900"
                        />
                    </div>
                </div>
                ...
                <div class="mt-5">
                    <accordion>
                        ...
                        <div
                            class="min-h-[50px] text-center border-b border-black text-2xl py-10"
                        >No offers yet</div>
                        <div class="px-4 py-3">
                            <nftmx-button
                                outline
